...
class ku040_sys_clock_mmcm0 extends BlackBox {
  ...
  ElaborationArtefacts.add(
    ...
    CONFIG.MMCM_CLKOUT6_DIVIDE {12} \
    CONFIG.NUM_OUT_CLKS {7} \
    CONFIG.CLKOUT1_JITTER {249.749} \
    CONFIG.CLKOUT1_PHASE_ERROR {161.613} \
    CONFIG.CLKOUT2_JITTER {219.549} \
    CONFIG.CLKOUT2_PHASE_ERROR {161.613} \
    CONFIG.CLKOUT3_JITTER {203.427} \
    CONFIG.CLKOUT3_PHASE_ERROR {161.613} \
    CONFIG.CLKOUT4_JITTER {191.870} \
    CONFIG.CLKOUT4_PHASE_ERROR {161.613} \
    CONFIG.CLKOUT5_JITTER {167.067} \
    CONFIG.CLKOUT5_PHASE_ERROR {161.613} \
    CONFIG.CLKOUT6_JITTER {154.579} \
    CONFIG.CLKOUT6_PHASE_ERROR {161.613} \
    CONFIG.CLKOUT7_JITTER {176.759} \
    CONFIG.CLKOUT7_PHASE_ERROR {161.613}
    ] [get_ips ku040_sys_clock_mmcm0] """
  )
}
...
class ku040_sys_clock_mmcm1 extends BlackBox {
  ...
  ElaborationArtefacts.add(
    ...
    CONFIG.MMCM_CLKOUT6_DIVIDE {1} \
    CONFIG.NUM_OUT_CLKS {2} \
    CONFIG.CLKOUT1_JITTER {196.549} \
    CONFIG.CLKOUT1_PHASE_ERROR {160.484} \
    CONFIG.CLKOUT2_JITTER {170.396} \
    CONFIG.CLKOUT2_PHASE_ERROR {160.484} \
    CONFIG.CLKOUT3_JITTER {190.636} \
    CONFIG.CLKOUT3_PHASE_ERROR {160.484}
    ] \
...
class ku040_sys_clock_mmcm2 extends BlackBox {
  ...
  ElaborationArtefacts.add(
    ...
    CONFIG.CLKIN1_JITTER_PS {40.0} \
    CONFIG.MMCM_DIVCLK_DIVIDE {5} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {18.0} \
    CONFIG.MMCM_CLKIN1_PERIOD {4.0} \
    CONFIG.MMCM_CLKOUT0_DIVIDE_F {72.000} \
    CONFIG.MMCM_CLKOUT1_DIVIDE {36} \
    CONFIG.MMCM_CLKOUT2_DIVIDE {24} \
    ...
    CONFIG.CLKOUT6_JITTER {154.579} \
    CONFIG.CLKOUT6_PHASE_ERROR {161.613} \
    CONFIG.CLKOUT7_JITTER {167.067} \
    CONFIG.CLKOUT7_PHASE_ERROR {161.613}
    ] [get_ips ku040_sys_clock_mmcm2] """
  )
}
