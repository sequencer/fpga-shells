...
class KU040MIGIODDR(depth : BigInt) extends GenericParameterizedBundle(depth) {
  require((depth<=0x100000000L),"KU040MIGIODDR supports upto 4GB depth configuraton")
...
class ku040mig(depth : BigInt)(implicit val p:Parameters) extends BlackBox
{
  ...
  override def desiredName = if(depth<=0x40000000) "ku040mig1gb" else "ku040mig4gb"
  ...
  val ku040mig1gbprj = """ {<?xml version='1.0' encoding='UTF-8'?>
<!-- IMPORTANT: This is an internal file that has been generated by the MIG software. Any direct editing or changes made to this file may result in unpredictable behavior or data corruption. It is strongly advised that users do not edit the contents of this file. Re-run the MIG GUI with the required settings if any of the options provided below need to be altered. -->
<Project NoOfControllers="1" >
    <ModuleName>ku040mig1gp</ModuleName>
   ...
   val ku040mig4gbprj = """ {<?xml version='1.0' encoding='UTF-8'?>
<!-- IMPORTANT: This is an internal file that has been generated by the MIG software. Any direct editing or changes made to this file may result in unpredictable behavior or data corruption. It is strongly advised that users do not edit the contents of this file. Re-run the MIG GUI with the required settings if any of the options provided below need to be altered. -->
<Project NoOfControllers="1" >
    <ModuleName>ku040mig4gb</ModuleName>
    <dci_inouts_inputs>1</dci_inouts_inputs>
    <dci_inputs>1</dci_inputs>
    <Debug_En>OFF</Debug_En>
    <DataDepth_En>1024</DataDepth_En>
  ...
  val migprj = if(depth<=0x40000000) ku040mig1gbprj else ku040mig4gbprj
  val migprjname =  if(depth<=0x40000000) """{/ku040mig1gb.prj}""" else """{/ku040mig4gb.prj}"""
  val modulename =  if(depth<=0x40000000)  """ku040mig1gb""" else """ku040mig4gb"""
