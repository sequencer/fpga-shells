if { [llength [get_ports -quiet chiplink_b2c_clk]] > 0 } {
  ...
  create_generated_clock -name {chiplink_c2b_clock} \
          -divide_by 1 \
          -source [ get_pins { ku040_sys_clock_mmcm0/inst/mmcm_adv_inst/CLKOUT6 } ] \
...
set group_sys [get_clocks -quiet {sys_diff_clk                    \
                                  clk_out*_ku040_sys_clock_mmcm1  \
                                  clk_out*_ku040_sys_clock_mmcm2  \
                                  chiplink_c2b_clock}]
set group_cl  [get_clocks -quiet {chiplink_b2c_clock              \
                                  clk_out*_ku040_sys_clock_mmcm3}]
